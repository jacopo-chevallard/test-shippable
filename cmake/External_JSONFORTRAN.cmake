...
ExternalProject_Add(
  ...
  CMAKE_ARGS -DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER} -DUSE_GNU_INSTALL_CONVENTION=ON -DCMAKE_Fortran_FLAGS=${CMAKE_Fortran_FLAGS} -DCMAKE_INSTALL_PREFIX=<INSTALL_DIR>  -DCMAKE_INSTALL_INCLUDEDIR=${JSONFORTRAN_CMAKE_INCLUDEDIR}
  )

set ( JSONFORTRAN_INCLUDE_DIR ${JSONFORTRAN_CMAKE_INCLUDEDIR} CACHE INTERNAL "JSONFORTRAN include directory" )
set ( JSONFORTRAN_LIBRARIES_DIR ${JSONFORTRAN_CMAKE_LIBDIR} CACHE INTERNAL "JSONFORTRAN library directory" )
set ( JSONFORTRAN_LIBRARIES ${JSONFORTRAN_LIBRARY_NAME} CACHE INTERNAL "JSONFORTRAN library" )
